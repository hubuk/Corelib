// -----------------------------------------------------------------------
// <copyright file="ParadigmTestCaseRunner.cs" company="Leet">
...
namespace Leet.Testing.Paradigmatic
{
    ...
    /// <summary>
    ///     The test case runner for paradigm tests.
    /// </summary>
    public class ParadigmTestCaseRunner : XunitTestCaseRunner
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ParadigmTestCaseRunner"/> class.
        /// </summary>
        /// <param name="testCase">
