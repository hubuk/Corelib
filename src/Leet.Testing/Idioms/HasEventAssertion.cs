// -----------------------------------------------------------------------
// <copyright file="HasEventAssertion.cs" company="Leet">
...
namespace Leet.Testing.Idioms
{
    ...
    /// <summary>
    ///     The idiomatic assertion that checks whether the specified type has specified event defined.
    /// </summary>
    public class HasEventAssertion : EventAssertion
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="HasEventAssertion"/> class.
        /// </summary>
        /// <param name="details">
        ...
        /// </exception>
        public HasEventAssertion(MemberDefinitionDetails details, string eventName, Type eventType)
        ...
        {
            AssertType.HasEvent(type, this.Details, this.EventName, this.EventType);
        }
    }
}
